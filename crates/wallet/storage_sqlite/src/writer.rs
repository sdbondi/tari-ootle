...
impl<'a> WriteTransaction<'a> {
    ...
    fn account_vault_in_diff(
        ...
        diff: &SubstateDiff,
    ) -> Result<Option<(VaultId, SubstateVersion)>, WalletStorageError> {
...
impl WalletStoreWriter for WriteTransaction<'_> {
    ...
    fn substates_upsert_root(
        ...
        diesel::insert_into(substates::table)
            .values((
                ...
                substates::version.eq(substate_id.version().as_u64() as i64),
            ))
    ...
    fn substates_upsert_child(
        ...
        diesel::insert_into(substates::table)
            .values((
                ...
                substates::referenced_substates.eq(serialize_json(&referenced_substates)?),
                substates::version.eq(address.version().as_u64() as i64),
            ))
            .on_conflict(substates::address)
            .do_update()
            .set((
    ...
    fn vaults_insert(&mut self, vault: VaultModel) -> Result<(), WalletStorageError> {
        ...
        let values = (
            ...
            vaults::vault_version.eq(i64::try_from(vault.vault_version.as_u64())
    ...
    fn vaults_update(
        ...
        let changeset = (
            vaults::vault_version.eq(i64::try_from(vault_version.as_u64())
    ...
    fn balance_changes_insert(
        ...
        let values = (
            ...
            account_balance_changes::vault_version.eq(change.vault_version.map(|v| v.as_u64() as i64)),
        ...
        let maybe_existing = account_balance_changes::table
            ...
            .filter(account_balance_changes::vault_version.eq(Some(vault_version.as_u64() as i64)))
            .select((
                account_balance_changes::id,
