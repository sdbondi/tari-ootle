...
use crate::{
    command::{
        evict_node_atom::EvictNodeAtom,
        foreign_proposal_atom::ForeignProposalAtom,
        mint_confidential_atom::MintConfidentialOutputAtom,
        transaction_atom::TransactionAtom,
    },
    ids::BlockId,
};
...
mod tests {
    ...
    use super::*;
    use crate::command::evidence::Evidence;
