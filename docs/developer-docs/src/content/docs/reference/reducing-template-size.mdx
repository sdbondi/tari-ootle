...
**There is a hard cap.** `MAX_PUBLISHABLE_TEMPLATE_BINARY_SIZE_BYTES` is **1 MiB**. A larger binary
...
`MAX_NATIVE_POINTS_PER_TRANSACTION`, and 1 MiB is the largest binary whose compile a transaction can
afford.
...
|---|---|---|
| 72 KiB | ~0.32 TARI | 240 µT |
| 96 KiB | ~0.35 TARI | 320 µT |
| 128 KiB | ~0.45 TARI | 430 µT |
| 256 KiB | ~2.9 TARI | 870 µT |
| 512 KiB | ~17.7 TARI | 1,740 µT |
| 1 MiB | ~92 TARI | 3,500 µT |
